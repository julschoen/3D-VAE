...
def main():
	...
	parser.add_argument('--n_res_block', type=int, default=2, help='How Many Res Blocks')
	parser.add_argument('--n_res_channel', type=int, default=32, help='ResBlock internal size')
